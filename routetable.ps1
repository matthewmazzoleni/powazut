...
$APPLICATION_NAME = $CUSTOMER_NAME + "-" + $APPLICATION_NAME + "-" + $RESOURCE_NAME_IDENTIFIER + "-" + $APPLICATION_TYPE + "-" + $LOCATION_SHORT + "-" + "001"
...
if( $isAClone -eq "Y") {
    ...
    $webApp = New-AzWebApp -ResourceGroupName $RESOURCE_GROUP -Name $APPLICATION_NAME -Location $LOCATION -AppServicePlan $APP_SERVICE_PLAN
}
